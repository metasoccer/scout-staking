...
contract MetaSoccerStaking is Context, Pausable, AccessControl, IERC721Receiver, ERC721Enumerable
{
    address public nftToStake;
    ...
    function withdrawWithoutRewards(uint256 _tokenId) external {
    ...
    function withdrawWithRewards(uint256 _tokenId) external {
    ...
    function setRewardTokens(address[] memory _tokens) external onlyRole(DEFAULT_ADMIN_ROLE) {
